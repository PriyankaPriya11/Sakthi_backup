...
// wp_register_script('scripts.js', get_stylesheet_directory_uri().'/assets/ele/scripts.js', array('scripts.js'),'', false);
...
wp_register_script('lax.min-js', get_stylesheet_directory_uri().'/assets/ele/lax.min.js', array('lax.min'), false);
wp_enqueue_script('lax.min-js');
wp_register_script('swiper.min', get_stylesheet_directory_uri().'/assets/ele/swiper.min.js', array('swiper.min.js'),'', false);
