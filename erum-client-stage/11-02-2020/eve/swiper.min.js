        ...
        classes: {
            addClasses: function() {
                ...
                e.forEach(function(c) {
                    console.log(c,'ghghgh');
                    console.log(a,'aaaa');
                    console.log(b,'bbbbb');
                    if(c == 'horizontal'){
                        if(b.el.classList[0] == 'titles-swiper'){
                        jQuery('.titles-swiper').removeClass(b.containerModifierClass + c);
                            a.push(b.containerModifierClass + 'vertical');
                        }else{
