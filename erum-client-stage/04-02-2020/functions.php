...
wp_register_script('owl.carousel', get_stylesheet_directory_uri().'/assets/css/owl-carousel/owl.carousel.js', array('okzp-js'),'', false);
...
wp_register_script('lax', get_stylesheet_directory_uri().'/assets/ele/lax.min.js', array('custom-shop'), false);
wp_enqueue_script('lax');
wp_register_script('swiper', get_stylesheet_directory_uri().'/assets/ele/swiper.min.js', array('lax'),'', false);
wp_enqueue_script('swiper');
wp_register_script('bootstrap-js', "https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js", array('swiper'),'', false);
wp_enqueue_script('bootstrap-js');
wp_register_script('aos-js', "https://unpkg.com/aos@2.3.1/dist/aos.js", array('bootstrap-js'),'', false);
wp_enqueue_script('aos-js');
wp_register_script('scripts', get_stylesheet_directory_uri().'/assets/ele/scripts.js', array('aos-js'),'', false);
