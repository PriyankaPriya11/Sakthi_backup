!function(a, b) {
    ...
    var s = {
        ...
        slideNext: function(a, b, c) {
            //jQuery('.swiper-slide-active').parent('.swiper-wrapper').parent('.portfolio-swiper').removeClass('swiper-container-horizontal');
            //jQuery('.swiper-slide-active').parent('.swiper-wrapper').parent('.portfolio-swiper').addClass('swiper-container-vertical');
