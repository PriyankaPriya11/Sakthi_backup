...
// wp_register_script('lax', get_stylesheet_directory_uri().'/assets/ele/lax.min.js', array('lax-js'), false);
// wp_enqueue_script('lax-js');
// wp_register_script('swiper', get_stylesheet_directory_uri().'/assets/ele/swiper.min.js', array('swiper'),'', false);
