              ...
              sizes="(max-width: 738px) 100vw, 738px"></a> 
                ...
                <div class="light-logo">
                    <a href="<?php echo site_url(); ?>" rel="home">
                        <img src="https://erum.askantech.com/wp-content/themes/erum/assets/images/logo-wt.png" class="ss-logo-wt">
                    </a>
                    <a href="<?php echo site_url(); ?>" rel="home">
                        <img src="https://erum.askantech.com/wp-content/themes/erum/assets/images/logo-bk.png" class="ss-logo-bk">
                    </a>
                </div>
            </div><!-- .site-branding -->
            <nav id="site-navigation" class="main-navigation">                
                ...
                <div class="fs-menu">
                    ...
                    <div class="menu-main-menu-container">
                        ...
                        <ul id="primary-menu" class="menu lang-es">
                            <li id="menu-item-348"
                        ...
                        <ul id="primary-menu" class="menu lang-en">
                            <li id="menu-item-348"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-348"><a
                                    href="javascript:void(0)">About Erum</a></li>
                            <li id="menu-item-348"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-348"><a
                                    href="javascript:void(0)">Catalogue</a></li>
                            <li id="menu-item-346"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-346"><a
                                    href="javascript:void(0)">Our clients</a></li>
                            <li id="menu-item-352"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-352"><a
                                    href="javascript:void(0)">I+D</a></li>
                            <li id="menu-item-349"
                            ...
                            <li id="menu-item-345"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-345"><a
                                    href="javascript:void(0)">Location</a></li>
                            <li id="menu-item-345"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-345"><a
                                    href="javascript:void(0)">Human Resources</a></li>
                        </ul>
                        <ul id="primary-menu" class="menu lang-fr">
                            <li id="menu-item-348"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-348"><a
                                    href="javascript:void(0)">À propos d'Erum</a></li>
                            <li id="menu-item-348"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-348"><a
                                    href="javascript:void(0)">Catalogue</a></li>
                            <li id="menu-item-346"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-346"><a
                                    href="javascript:void(0)">Nos clients</a></li>
                            <li id="menu-item-352"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-352"><a
                                    href="javascript:void(0)">I+D</a></li>
                            <li id="menu-item-349"
                            ...
                            <li id="menu-item-345"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-345"><a
                                    href="javascript:void(0)">Emplacement</a></li>
                            <li id="menu-item-345"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-345"><a
                                    href="javascript:void(0)">Ressources humaines</a></li>
                        </ul>
