(function(jQuery){
    jQuery.fn.horizontalScroll = function(options) {
     ...
     return this.each(function() {
                   ...
                   var horiz_scroll = new dw_scrollObj(jQuery(this).attr('id'), jQuery(this).children().attr('id'), jQuery(this).children().children().attr('id'));
   ...
   dw_scrollObj.handleMouseOverDownLinks = function (linkEl, wndoId, cls) {
       ...
       var re = /^(mouseover|mousedown)_(up|down|left|right)(_[\d]+)?jQuery/;
   ...
   dw_scrollObj.handleClick = function (linkEl, wndoId, cls) {
       ...
       var parts = cls.split('_'); var eType = parts[0];
       var dur_re = /^([\d]+)jQuery/; var fn, re, x, y, dur;
   
       switch (eType) {
           case 'scrollTo' :
               fn = 'scrollTo';  re = /^(null|end|[\d]+)jQuery/;
               x = re.test( parts[1] )? parts[1]: '';
               y = re.test( parts[2] )? parts[2]: '';
               dur = ( parts[3] && dur_re.test(parts[3]) )? parts[3]: null;
               break;
           case 'scrollBy': // scrollBy_m30_m40, scrollBy_null_m100, scrollBy_100_null
               fn = 'scrollBy';  re = /^(([m]?[\d]+)|null)jQuery/;
               x = re.test( parts[1] )? parts[1]: '';
               y = re.test( parts[2] )? parts[2]: '';
   ...
   dw_scrollObj.getClickParts = function(cls) {
       ...
       var re = /^(up|down|left|right)jQuery/;
