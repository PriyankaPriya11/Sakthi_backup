...
jQuery(document).ready(function () {
    ...
    jQuery( ".woof_redraw_zone h4" ).click(function() {
        jQuery(this).parent().toggleClass("ss-cioin");
    });
    jQuery(function() {
        jQuery('.woof_container_inner_tipodelproducto').addClass('ss-cioin');
    });
    jQuery( '.lx-seb1' ).keyup(function() {
        if( jQuery('input#Sebasti').val() ) {
           jQuery('input#Sebasti, label.control-label.lx-lable.ss-sab, label.control-label.lx-lable.ss-sab-1').addClass('not-empty');
        } else {
           jQuery('input#Sebasti, label.control-label.lx-lable.ss-sab, label.control-label.lx-lable.ss-sab-1').removeClass('not-empty');
        }
        if( jQuery('input#EMPRESA').val() ) {
            jQuery('input#EMPRESA, label.control-label.lx-lable.ss-emp, label.control-label.lx-lable.ss-emp-1').addClass('not-empty');
         } else {
            jQuery('input#EMPRESA, label.control-label.lx-lable.ss-emp, label.control-label.lx-lable.ss-emp-1').removeClass('not-empty');
         }
         if( jQuery('input#EMAIL').val() ) {
            jQuery('input#EMAIL, label.control-label.lx-lable.ss-eml,  label.control-label.lx-lable.ss-eml-1').addClass('not-empty');
         } else {
            jQuery('input#EMAIL, label.control-label.lx-lable.ss-eml,  label.control-label.lx-lable.ss-eml-1').removeClass('not-empty');
         }
         if( jQuery('input#TELFONO').val() ) {
            jQuery('input#TELFONO, label.control-label.lx-lable.ss-tel,  label.control-label.lx-lable.ss-tel-1').addClass('not-empty');
         } else {
            jQuery('input#TELFONO, label.control-label.lx-lable.ss-tel,  label.control-label.lx-lable.ss-tel-1').removeClass('not-empty');
         }         
    });
    jQuery( '.lx-seb11' ).keyup(function() {
        if( jQuery('input#CUNTANOS').val() ) {
            jQuery('input#CUNTANOS, label.control-label.lx-lable.ss-cqc, label.control-label.lx-lable.ss-cqc-1').addClass('not-empty');
        } else {
            jQuery('input#CUNTANOS, label.control-label.lx-lable.ss-cqc, label.control-label.lx-lable.ss-cqc-1').removeClass('not-empty');
        }
    });
});
jQuery(document).ready(function () {
