<div class="wrap sr">
    ...
    <ul class="body">
        ...
        <li class="<?= $sr_wc_p360v_animation != 'true' ? 'sr-disabled' : '';?>">
        ...
        <li>
            ...
            <select id="rotation_speed">
                <option <?= $sr_wc_p360v_image_rotation_speed == 20 ? 'selected' : ''; ?> value="20"><?= __('Fast', 'sr-product-360-view'); ?></option>
                <option <?= $sr_wc_p360v_image_rotation_speed == 40 ? 'selected' : ''; ?> value="40"><?= __('Normal', 'sr-product-360-view'); ?></option>
                <option <?= $sr_wc_p360v_image_rotation_speed == 60 ? 'selected' : ''; ?> value="60"><?= __('Medium', 'sr-product-360-view'); ?></option>
                <option <?= $sr_wc_p360v_image_rotation_speed == 80 ? 'selected' : ''; ?> value="80"><?= __('Slow', 'sr-product-360-view'); ?></option>
            </select>
        </li>
        <li>
            <?php
            ...
            ?>
            <h2 class="title"><?= __('Image rotation control :', 'sr-product-360-view'); ?></h2>
            <select id="rotation_control">
                <option <?= $sr_wc_p360v_image_rotation_control == __('sr_wc_p360v_image_rotation_control_1', 'sr-product-360-view') ? 'selected' : ''; ?> value="1"><?= __('Mouse move & drag', 'sr-product-360-view'); ?></option>
                <option <?= $sr_wc_p360v_image_rotation_control == __('sr_wc_p360v_image_rotation_control_2', 'sr-product-360-view') ? 'selected' : ''; ?> value="2"><?= __('Mouse drag', 'sr-product-360-view'); ?></option>
            </select>
        </li>
        <li>
        ...
        <li>
            ...
            ?>
            <h2 class="title"><?= __('360&#176; view images size :', 'sr-product-360-view'); ?></h2>
            <select id="img_size">
                <option <?= $sizeMode == 'original' ? 'selected' : ''; ?> value="original"><?= __('Original', 'sr-product-360-view'); ?></option>
                <option <?= $sizeMode == 'stretch' ? 'selected' : ''; ?> value="stretch"><?= __('Stretch', 'sr-product-360-view'); ?></option>
            </select>
        </li>
        <li>
            ...
            <div id="faqs" class="help-center-data">
                ...
                <div class="faqs-content">
                    ...
                    <div class="faqs-block">
                        ...
                        <p class="answer">You can simply send email to <a href='mailto:admin@superrishi.com' target="_top">admin@superrishi.com</a> or can visit the website <a href='http://superrishi.com' target='_blank'>SUPERRISHI.COM</a>.</p>
                    </div>
                </div>
            </div>
...
<div class="popup__overlay">
    <div class="popup" id="popupVid">
        ...
        <iframe src="https://www.youtube.com/embed/LEpqHhn0LNo?showinfo=0&rel=0&enablejsapi=1" frameborder="0" allowfullscreen></iframe>
    </div>
</div>
<script>
...
//Choose icon end
    ...
    jQuery("#animation").on('change', function(){
        if (jQuery("#animation").is(":checked")) {
            jQuery("#animation_reverse").closest('li').removeClass('sr-disabled');
        } else {
            jQuery("#animation_reverse").closest('li').addClass('sr-disabled');
