...
//Widget Setup
    ...
    {
        parent::__construct(__CLASS__, __('WOOF - CERRAR', 'woocommerce-products-filter'), array(
            'classname' => __CLASS__,
            'description' => __('CERRAR by realmag777', 'woocommerce-products-filter')
                )
        );
    }
...
//Defaults
        $defaults = array(
            'title' => __('CERRAR', 'woocommerce-products-filter'),
