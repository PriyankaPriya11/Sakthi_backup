...
<div class="cc-map-section">
    ...
    <div class="row">
        <div id='map'>
            <img class="leaflet-image-layer cc-overlayimg" src="/wp-content/themes/erum/map/assets/image/whitebg.png"
                alt="">
        </div>
...
jQuery(document).ready(function() {
    var mapslider = jQuery('.bxslider').bxSlider({
        ...
        onSlideAfter: function(jQueryslideElement, oldIndex, newIndex) {
            ...
            jQuery(jQueryslideElement).next().addClass('active-slide');

            let popupValue = jQuery('.slide.active-slide').attr('data-slideval');
            jQuery('.cc-map-point').removeClass('active');
            jQuery(`.cc-map-point:eq(jQuery{popupValue - 1})`).addClass('active')
        }
