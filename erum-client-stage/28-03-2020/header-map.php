              ...
              sizes="(max-width: 738px) 100vw, 738px"></a> 
                ...
                <div class="light-logo">
                    <a href="<?php echo site_url(); ?>" rel="home">
                        <img src="<?php echo site_url(); ?>/wp-content/themes/erum/assets/images/logo-wt.png">
                    </a>
                    <a href="<?php echo site_url(); ?>" rel="home">
                        <img src="<?php echo site_url(); ?>/wp-content/themes/erum/assets/images/logo-bk.png">
                    </a>
                </div>
            </div><!-- .site-branding -->
                        ...
                        <div class="ss-social-links">
                            ...
                            <div class="ss-menu-social">
                                <a href="javascript:void(0)"><img
                                        src="<?php echo site_url(); ?>/wp-content/themes/erum/assets/images/fb.png"></a>
                                <a href="javascript:void(0)"><img
                                        src="<?php echo site_url(); ?>/wp-content/themes/erum/assets/images/linkedin.png"></a>
                                <a href="javascript:void(0)"><img
                                        src="<?php echo site_url(); ?>/wp-content/themes/erum/assets/images/instagram.png"></a>
                            </div>
                        </div>
                            ...
                            <section id="text-2" class="widget widget_text">
                                <div class="textwidget">
                                    <h5><img class="alignnone wp-image-67 size-full"
                                            src="<?php echo site_url(); ?>/wp-content/themes/erum/assets/ele/eeeee.png"
