 ...
 */
get_header(); ?>
<link rel="stylesheet" href="map/assets/css/jquery.bxslider.css">
<link rel="stylesheet" href="map/assets/css/map.css">
...
<body>
    ...
    <div class="cc-map-section">
        ...
        <div id='map'>
            <img class="leaflet-image-layer cc-overlayimg" src="/map/assets/image/whitebg.png" alt="">
        </div>
                ...
                <div class="bxslider">
                    ...
                    <div class="slide" data-slideval="8">
                        <div class="cc-map-details">
                            ...
                            <div class="cc-md">
                                <div class="cc-md-img">
                                    <img src="map/assets/image/flag1.png" alt="">
                                </div>
    ...
    <script src="map/assets/js/jquery.mousewheel.min.js"></script>

    <script src="map/assets/js/bxslider.js"></script>
            ...
            <div class="cc-map-point" data-popupimg="0"> 
                <div class="cc-imgpopup">
                    <div class="cc-img-wrapper">
                        <img src="/map/assets/image/popupflag.png" alt="popupflag">
                    </div>
