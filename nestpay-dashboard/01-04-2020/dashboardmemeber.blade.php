        ...
        <div class="col-xxl-3">
            <div class="row h-full">
                ...
                <div class="col-xxl-12 col-lg-3 h-p50 h-only-lg-p100 h-only-xl-p100">
                    <!-- Panel Today's Sales -->
                    <div class="card card-shadow card-inverse bg-blue-600 white ss-bg">
                        <div class="card-block p-30">
                            <div class="counter counter-lg counter-inverse text-left changetext">
                                <div class="counter-label mb-20">
                                    ...
                                    <div class="ss-btn-pay">
                                        <img src="http://payhot.in/pay-ig.png" alt="ss-ig" class="ss-pay">
                                        <button type="submit" data-status="1" id="sendpaymentdashboardclick"
...
@media only screen and (max-width:375px) {
    ...
    .transactioncard .p-30 {
        padding: 8px !important;
    }

    .transactioncard .changetext {
        font-size: 18px;
    }
}
