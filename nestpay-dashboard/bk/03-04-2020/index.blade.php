                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" target="_blank" href="/aboutus">About Us</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" target="_blank" href="/howitworks">How It Works</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" target="_blank" href="/services">Service</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" target="_blank" href="/price">Pricing</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" target="_blank" href="/contact">Contact</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->

                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" data-scroll-nav="0" target="_blank" href="/login">Sign In</a>
                                <a class="main-btn" data-scroll-nav="0" target="_blank" href="/becomeconsumer">Sign Up</a>
                                <a class="main-btn" data-scroll-nav="0" target="_blank" href="/becomeagent">Become an Agent</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
                    ...
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">
                                Lorem Ipsum has been the industry's</h3>
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">Lorem
                                Ipsum</h2>
                            ...
                            <a href="#" class="main-btn wow fadeInUp" data-wow-duration="1.3s"
                                data-wow-delay="1.1s">Subscribe</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Our USPs</a></h4>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Fast & Secure</a></h4>
                            <p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod
                                tempor invidunt labore.</p>
                            <a class="more" href="#">Learn More <i class="lni-chevron-right"></i></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">No Extra Hardware</a></h4>
                            <p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod
                                tempor invidunt labore.</p>
                            <a class="more" href="#">Learn More <i class="lni-chevron-right"></i></a>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">We provide services for</h3>
                        </div> <!-- section title -->
                        ...
                        <div class="ss-button">
                            <a href="https://play.google.com/store/apps/details?id=in.spotcash&amp;hl=en&amp;hl=en"
                                target="_blank">
                                <img src="https://www.spotcash.in/images/googleplay.png">
                            </a>
                            <a href="https://play.google.com/store/apps/details?id=in.spotcash" target="_blank">
                                <img src="https://www.spotcash.in/images/AppStoreButton.gif">
                            </a>
                        </div>
                    </div> <!-- about content -->
                </div>
            ...
            <div class="row">
                <div class="ss-st">
                    <div class="container">
                        <div class="box">
                            <div class="icon">
                                <img src="../../assets/images/online-payment-ig.png" alt="ss-ig">
                            </div>
                            <div class="content">
                                <h3>Pay to Mobile</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga iusto aperiam culpa
                                    excepturi enim harum!</p>
                                <a href="#">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                        <div class="box">
                            <div class="icon">
                                <img src="../../assets/images/email-ig.png" alt="ss-ig">
                            </div>
                            <div class="content">
                                <h3>Pay to Email</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga iusto aperiam culpa
                    ...
                    <div class="container">
                        <div class="box">
                            <div class="icon">
                                <img src="../../assets/images/pay-ig.png" alt="ss-ig">
                            </div>
                            <div class="content">
                                <h3>Pay to Bank</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga iusto aperiam culpa
                            ...
                            <div class="col-4">
                                <div
                                    ...
                                    <div class="counter-items text-center">
                                        ...
                                        <p class="text">Successful Transaction
                                        </p>
                                    </div>
                                </div> <!-- single counter -->
                            </div>
