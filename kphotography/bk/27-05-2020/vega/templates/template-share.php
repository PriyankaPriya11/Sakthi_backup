...
<div <?php if(is_bool($blog_list_template) && $blog_list_template) { ?>class="social_share_wrapper"<?php } else { ?>id="social_share_wrapper"<?php } ?>>
	<ul>
		...
		<li><a title="<?php _e( 'Share On Pinterest', THEMEDOMAIN ); ?>" target="_blank" href="https://www.pinterest.com/pin/create/button/?url=<?php echo urlencode($share_page_url); ?>&amp;media=<?php echo urlencode($pin_thumb[0]); ?>"><i class="fa fa-pinterest marginright"></i></a></li>
