...
function pp_enqueue_front_page_scripts() {
	...
	else
	{
		if(empty($pp_animation))
	    {
			...
			wp_enqueue_style("owl-carousel", $file_dir."/wp-content/themes/vega/css/owl.carousel.min.css", false, THEMEVERSION, "all");
			wp_enqueue_style("owl.theme", $file_dir."/wp-content/themes/vega/css/owl.theme.default.min.css", false, THEMEVERSION, "all");
	    }
