...
<div id="page_content_wrapper" class="two">
    ...
    <div class="inner">
		...
		<img src="https://kpolidanphotography.mdh80f8f-liquidwebsites.com/wp-content/uploads/2020/05/image-asset-2.png" alt="ss-ig" class="ss-blg">
				    ...
				    ?>
						<div class="post_img">
							...
							<?php $thumbnail = get_post( get_post_thumbnail_id() ); ?>
													<img src="<?php if(get_post_thumbnail_id()) { echo rw_resize(get_post_thumbnail_id(),260,145); }?>" class=""  />
						    </a>
						</div>
				    <?php
				    	}
