							...
							?>
								...
								<div style="display:none;">
								    <div id="video_<?php echo $portfolio_video_id; ?>" class="lightbox_video_wrapper">
								        ...
								        <iframe title="YouTube video player" width="960" height="540" src="https://www.youtube.com/embed/<?php echo $portfolio_video_id; ?>?theme=dark&rel=0&wmode=transparent" frameborder="0" allowfullscreen></iframe>
							...
							?>
								...
								<div style="display:none;">
								    <div id="video_<?php echo $portfolio_video_id; ?>" class="lightbox_video_wrapper">
								        ...
								        <iframe src="https://player.vimeo.com/video/<?php echo $portfolio_video_id; ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="960" height="540" frameborder="0"></iframe>
