...
<ul class="portfolio_wall_filters filter full"> 
    <li>
    	<a <?php if(!isset($_GET['view'])) { ?>class="active"<?php } ?> href="<?php echo esc_url(get_permalink($current_page_id)); ?>"><?php echo _e('All', THEMEDOMAIN ); ?></a>
    	<span class="separator">/</span>
    </li>
    <li>
    	<a <?php if(isset($_GET['view']) && $_GET['view'] == 'approve') { ?>class="active"<?php } ?> href="<?php echo esc_url(add_query_arg('view', 'approve', get_permalink($current_page_id))); ?>"><?php echo _e('Approved Photos', THEMEDOMAIN ); ?></a>
    	<span class="separator">/</span>
    </li>
    <li>
    	<a <?php if(isset($_GET['view']) && $_GET['view'] == 'reject') { ?>class="active"<?php } ?> href="<?php echo esc_url(add_query_arg('view', 'reject', get_permalink($current_page_id))); ?>"><?php echo _e('Rejected Photos', THEMEDOMAIN ); ?></a>
    	<span class="separator">/</span>
    </li>
</ul>
	    		...
	    		?>
					...
					?>		
	    				<div id="image<?php echo esc_attr($photo_id); ?>_wrapper" class="image_wrapper">
	    					...
	    					<div class="onapprove <?php if(!$is_approved) { ?>hidden<?php } ?>"><?php _e('Approve', THEMEDOMAIN ); ?></div>
