            ...
            if (b.get_raw_json) b.callback(JSON.stringify({
                ...
                if (b.display_gallery)
                    if (a.is_private) c += "<p class='instagram_private'><strong>This profile is private</strong></p>";
                        ...
                        for (d = 0; d < g; d++) f = "https://www.instagram.com/p/" + e[d].node.shortcode, c += "<div class='col-sm-2'>" + "<div class='content11'>" + "<a href='" + f + "' rel='noopener' target='_blank'>", c += "\t<img src='" + e[d].node.thumbnail_src + "' alt='" + b.username + " instagram image " + d + "'" + k + " class='content-image'/><div class='content-overlay'>" + "</div>" + "<div class='content-details fadeIn-bottom'>" + "<div class='content-text'>" + "<p>" + e[d].node.edge_media_to_caption.edges[0].node.text.substring(0,250) + "</p>" + "</div>" + "</div>" + "</div>" + "</div>", c += "</a>";
                        c += "</div>"
                    } if (b.display_igtv)
                    if (a.is_private) c += "<p class='instagram_private'><strong>This profile is private</strong></p>";
                    else {
