...
<div id="content" class="gridlove-site-content container new-search">
    ...
    <div class="row gridlove-posts yoyo2">
            ...
            <div class="cc-sidebar-stick ">
                ...
                <div class="cc-sidebar-content-fixed <?php if($tmplt == 2){echo 'tmplttwo';}?> <?php if($tmplt == 3){echo 'tmpltthree';}?>">
                    ...
                    <?php if($tmplt == 3): ?>
                        <div>
                            ...
                            ?>
                            <div class="ss-art">
                            <span class="ss-ar">Article Results</span>
                            <div class="ss-article-results">
                                <?php  while( $query->have_posts()): $query->the_post(); { ?>
                                    <div class="cc-article-results">
                                        ...
                                        <span class="articles-knowzo__description" style="color: #333;font-size: 13px;line-height: 18px;"><?php echo wp_trim_words(get_the_content(),25, '...' ); ?></span><br>
                                    </div>
                            <?php } 
                                    endwhile;  
                                else:  
