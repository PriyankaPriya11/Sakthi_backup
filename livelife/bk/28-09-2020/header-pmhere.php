...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/_css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css">
    <link rel="stylesheet" type="text/css" href="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/style.css">
    <link rel="stylesheet" href="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/_css/owl.carousel.min.css">
    <!-- <script src="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/_css/jquery.min.js"></script> -->
    <!-- <script src="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/_css/owl.carousel.js"></script> -->
	<link rel="stylesheet" type="text/css" href="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/_css/jquery-swipe-nav.css" media="all" />
    <!-- <script type="text/javascript" src="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/js/jquery-swipe-nav-plugin.js"></script> -->
    <style>
        html{
...
div#mobile .sidebar{
    ...
    content: url(https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/img/clear.png);
}
img.menu-sec.active2.img1 {
    content: url(https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/img/menu.png);
}
div#mobile img.menu-sec.toggle {
    position: absolute;
    right: 13px;
    ...
    <section id="section1">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-1">
                      <img src="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/img/menu.png" class="menu-sec sidebarBtn "  id="menuBtn">
                </div>
  ...
  <img src="<?php echo $image[0];?>"  class="logo_sec">
                    ...
                    <div class="col-md-7">
                        ...
                        <div >
							...
							<div class="">
								<form role="search" method="get" class="search_1" action="<?php echo site_url().'/search2.php'; ?>">
											<input class="search__input search-form" type="search" placeholder="Search Guides..." value="<?php echo $word; ?>" name="swpquery" title="Search for:">
                ...
                <?php if(is_page(217)){?>
                    ...
                    <div class="col-md-7 bedrooms">
                     ...
                     <div class="author">
                         <img src="https://www.livelife.guide/newstaging/wp-content/uploads/2020/07/author.png">
                         <p>Author - Aimee<br>
                ...
                <div class="col-md-12 author_header">
                        ...
                        <div class="col-md-3">
                            <div class="author_imgs">
                              <img src="https://www.livelife.guide/newstaging/wp-content/uploads/2020/07/author_imgs.png" class="author_img_1_1">
                              <ul class="icons">
                                <li><a href=""><img src="https://www.livelife.guide/newstaging/wp-content/uploads/2020/07/ytube.png"></a></li>
                                <li><a href=""><img src="https://www.livelife.guide/newstaging/wp-content/uploads/2020/07/fb.png"></a></li>
                                <li><a href=""><img src="https://www.livelife.guide/newstaging/wp-content/uploads/2020/07/instagram.png"></a></li>
               ...
               <?php } ?>
                ...
                <div class="col-md-12" id="mobile">
                    ...
                    <div class="col-md-6 ">
                     ...
                     <img src="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/img/menu.png" class="menu-sec active2">
                     <img src="https://www.livelife.guide/newstaging/wp-content/themes/gridlove-child-theme/img/Frame.png"  class="logo_sec">
                    </div>
                    </div>
