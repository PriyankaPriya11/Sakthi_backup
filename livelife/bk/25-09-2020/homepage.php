                ...
                <div class="col-md-11 md2">
                    ...
                    <div class="col-md-3">
                        <?php
                                    ...
                                    ?>
                        <div class="title1">
                            <h3 class="main-title1"><a href="<?php the_permalink();?>"><?php $categories = get_the_category();echo $categories[0]->name;?></a></h3>
                    ...
                    <div class="owl-carousel owl-theme" id="carousel1">
                        ...
                        <div class="item" data-dot="<button>0<?php echo $i; ?></button>">
                            ...
                            <div class="carousel_item1">
                                <h3 class="carousle_title_1"><a href="<?php the_permalink();?>"><?php $categories = get_the_category();echo $categories[0]->name;?></a></h3>
                                <p><?php the_title();?></p>
                                <div class="sub-line">
            ...
            <div class="col-md-12 md-12-section">
                ...
                <div class="col-md-7 md-10">
                    ...
                    <div class="home_section">
                        ...
                        <h3><a href="<?php the_permalink();?>"><?php $categories = get_the_category();echo $categories[0]->name;?></a></h3>
