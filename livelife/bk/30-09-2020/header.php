...
<body <?php body_class(); ?>>
	...
	<header id="header" class="gridlove-site-header yoyo header hidden-md-down <?php echo esc_attr( $header_orientation_class ); ?> <?php echo esc_attr( $shadow_class ); ?>">
        <?php //if(!wp_is_mobile()): ?>	
					...
					<div class="container">
						<div class="gridlove-slot-c">
							<?php if(isset($_REQUEST['swpquery'])){ $word = $_REQUEST['swpquery']; $word = str_replace("+"," ",$word); }else{
									$word = 'Search Guides...'; } $id = get_field( 'fid_related', 8214); ?>
							<div class="testing">
