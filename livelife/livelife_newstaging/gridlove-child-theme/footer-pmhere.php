...
<?php endif; ?>
                                 ...
                                 <div class="col-md-8">
                                     ...
                                     <div class="col-md-4 footer_m4"><span class="topics">Folow us</span>
                                        <ul class="topic_list1">
                                            <li><a href=""><img src="https://www.livelife.guide/wp-content/themes/gridlove-child-theme/img/fb.png"></a></li>
                                            <li><a href=""><img src="https://www.livelife.guide/wp-content/themes/gridlove-child-theme/img/instagram.png"></a></li>
                                            <li><a href=""><img src="https://www.livelife.guide/wp-content/themes/gridlove-child-theme/img/ytube.png"></a></li>
                                        </ul>
           ...
           <script>
            jQuery(document).ready(function() {
                ...
                <script>
                    jQuery(".title1 p").text(function(index, currentText) {
                        return currentText.substr(0, 280);
                    });
                    jQuery(".beauty_content1 p").text(function(index, currentText) {
                        return currentText.substr(0, 200);
                    });  
                    jQuery(".beauty_content1 p").text(function(index, currentText) {
                        return currentText.substr(0, 200);
                    });                      
                    jQuery(".wel-content p").text(function(index, currentText) {
                        return currentText.substr(0, 120);
                    });    
                    jQuery(".recent-content p ").text(function(index, currentText) {
