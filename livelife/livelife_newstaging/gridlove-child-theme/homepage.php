...
<section id="four">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 ss-entertainment">
                <div class="col-md-1">
                    <div class="side_title">
                ...
                <div class="col-md-7 md-10 ss-enter">
                ...
                <div class="col-md-4 ss-mob-form">
                    <div class="col-md-1">
                    ...
                    <div class="col-md-11">
                        <div class="home_form">
                            ...
                            <?php echo do_shortcode( '[contact-form-7 id="14431" title="Subscription"]' ); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-11">
                    ...
                    <a href="<?php the_permalink();?>"><?php
                        ...
                        <div class="post_content">
                            <h3><a href="<?php the_permalink();?>"><?php $categories = get_the_category();echo $categories[0]->name;?></a>
                            </h3>
                            <h4><a href="<?php the_permalink();?>"><?php the_title();?></a></h4>
                            <div class="sub-line">
                                <div class="right-line"></div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-11 md33">
                    <div class="col-md-8 md88">
                        ...
                        <?php endforeach; wp_reset_postdata();}?>
                        <a href="https://www.livelife.guide/environment/" class="more">MORE FROM</a>
                    </div>
                    <div class="col-md-4 md34 ss-mob-form">
                        <div class="col-md-1">
                            <div class="title_rotate">
                                <h3><?php echo get_field('newletter');?></h3>
                            </div>
