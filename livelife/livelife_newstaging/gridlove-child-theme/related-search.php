...
*/
	global $post;
		...
		if ( class_exists( 'SWP_Query' ) ) {
			$engine = 'related_key_search'; // taken from the SearchWP settings screen
			...
			<div class="cc-wrapp-search-pages">
				<div class="row gridlove-posts yoyo2">
					...
					<?php $ad_no = 1; foreach ( $swp_query->posts as $post ) {
						...
						// output the result
						?>
						<div class="col-lg-12 col-md-12 col-sm-12 layout-simple ad-no-<?php echo $ad_no; ?>">
							<article class="gridlove-post gridlove-post-b gridlove-box  post-<?php echo $post->ID; ?>">
							<div class="box-inner-ptbr box-col-b entry-sm-overlay">
							<div class="box-inner-ellipsis">
								...
								<div class="entry-content">
									<?php $content = substr(get_the_excerpt(),0, 320);
											echo $content;
				...
				<?php if($GLOBALS[ 'result_count' ] > 3 ){ ?> 
					<?php if(get_field('related_search',8214)==true){?>
						<?php //if(!wp_is_mobile()):?>
							<!--<div class="cc-sidebar-content relatedResults" style="display:none;">
