...
.FormWrapper.tip_new_01.tip_left {
    padding: 30px 0;
}
p#result .row:not(:nth-child(2)) .text1:first-child label.label-text { margin-left: -10px;}
p#result .row:not(:nth-child(2)) .input:last-child input.input-fld { margin-left: -3px;}
     </style>
  </head>
  <body> 
  
    <div class="FormWrapper tip_new_01 tip_left">    
        <div class="row">
            <div class="text1">
