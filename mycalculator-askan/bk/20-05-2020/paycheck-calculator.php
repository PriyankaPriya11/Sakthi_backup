                ...
                <div class="Percentage">
                    <div class="overflow">
                        <div class="form block" amp-fx="fly-in-bottom">
                            ...
                            <div class="FormWrapper FormWrapper3 FormWrapper8">
                                <div class="row">
                                    <div class="text1">
                                    ...
                                    <div submit-success style ="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                                        <template type="amp-mustache">      
                                            <div class="row">
                                                ...
                                                <div class="inputHome inputhomecopy inputhomecopy3" style ="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                                                    {{output1}}
                                                </div>
                                            </div>
                                            <div class="row">
