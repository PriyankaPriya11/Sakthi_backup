...
var bl_amt=parseFloat(Billamount);
                        ...
                        text +="<div class='row' ><div class='text1'><label class='label-text'>Tip Percent</label></div><div class='text1'><label class='label-text'>Tip Amount</label></div><div class='text1'><label class='label-text'>Total</label></div></div><div class='row'><div class='text1'><label class='label-text'>5%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total.toFixed(2)+ "' readonly></div></div><div class='row'><div class='text1'><label class='label-text'>10%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount10+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total10.toFixed(2)+ "' readonly></div></div><div class='row'><div class='text1'><label class='label-text'>15%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount15+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total15.toFixed(2)+ "' readonly></div></div><div class='row'><div class='text1'><label class='label-text'>20%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount20+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total20.toFixed(2)+ "' readonly></div></div><div class='row'><div class='text1'><label class='label-text'>25%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount25+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total25.toFixed(2)+ "' readonly></div></div><div class='row'><div class='text1'><label class='label-text'>30%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount30+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total30.toFixed(2)+ "' readonly></div></div><div class='row'><div class='text1'><label class='label-text'>40%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount40+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total40.toFixed(2)+ "' readonly></div></div><div class='row'><div class='text1'><label class='label-text'>50%</label></div><div class='input'><input type='text' name='y' class='input-fld' value='" + tipamount50+ "' readonly></div><div class='input'><input type='text' name='y' class='input-fld' value='" + total50.toFixed(2)+ "' readonly></div></div>";
