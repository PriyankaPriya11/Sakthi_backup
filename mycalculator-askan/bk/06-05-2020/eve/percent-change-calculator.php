                        ...
                        <div class="form block" amp-fx="fly-in-bottom">
                            ...
                            <div class="FormWrapper FormWrapper4">
                                <div class="row">
                                    ...
                                    <div class="input">
                                        <input type="number" min="1" size="3" id="amount" class="input-fld" on="input-throttled:AMP.setState({getinput6:{per6: event.value}});input-debounced:AMP.setState({charState_fsblock_one: event.value <=  0  ? 'Please input numerical values greater than 0' :  '' }),msg_fs_one.show" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text1">
                                    ...
                                    <div class="input">
                                        <input type="number" min="1" size="7" id="percentage" class="input-fld" on="input-throttled:AMP.setState({getinput6:{totl_amt6: event.value}});input-debounced:AMP.setState({charState_fsblock_one: event.value <=  0  ? 'Please input numerical values greater than 0' :'' }),msg_fs_one.show" />
                                    </div>
                                    <div class="text2">
                ...
                <div class="Percentage">
                    ...
                    <div class="overflow">
                        <div class="form block" amp-fx="fly-in-bottom">
                            ...
                            <div class="img-cal">
                                <amp-img alt=" Percent Decrease calculator" src="images/percent-decrease-calculator.png" width="160" height="70" layout="responsive" class="heartBeat"></amp-img>
                            </div>
                            ...
                            <div class="FormWrapper FormWrapper4">
                                <div class="row">
                                    ...
                                    <div class="input">
                                        <input type="number" min="1" size="3" id="amount" class="input-fld" on="input-throttled:AMP.setState({getinput7:{per7: event.value}});input-debounced:AMP.setState({charState_fsblock_two: event.value <=  0  ? 'Please input numerical values greater than 0' :   '' }),msg_fs_two.show" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text1">
                                    ...
                                    <div class="input">
                                        <input type="number" min="1" size="7" id="percentage" class="input-fld" on="input-throttled:AMP.setState({getinput7:{totl_amt7: event.value}});input-debounced:AMP.setState({charState_fsblock_two: event.value <= 0 ?  'Please input numerical values greater than 0' :''}),msg_fs_two.show" />
                                    </div>
                                    <div class="text2">
                                        <label class="label-text">?</label>
                                    </div>
