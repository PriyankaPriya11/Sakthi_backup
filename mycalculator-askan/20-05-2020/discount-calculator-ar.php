                ...
                <div class="overflow">
                    <div class="form block calContainer" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class=" FormWrapper FormWrapper13">
                                <div class="row">
                                    <div class="text1">
                ...
                <div class="overflow">
                    <div class="form block disC" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="row FormWrapper FormWrapper2 FormWrapper7">
                                <!-- <div class="row"> -->
                                <div class="row">
            ...
            <div class="Percentage">
                ...
                <div class="overflow">
                    <div class="form block" amp-fx="fly-in-bottom">
                        <h2>المبلغ الثابت من الآلة الحاسبة</h2>
                        <div class="img-cal">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="row FormWrapper FormWrapper13">
                                <div class="row">
                                    <div class="text1 text1copy2">
                                ...
                                <div class="row">
                                    <div class="text1 text1copy2">
                                        <label class="label-text">مقدار الخصم</label>
                                    </div>
                                    <div class="input">
                                        ...
                                        <template type="amp-mustache">
                                            <div class="row">
                                                <div class="text1 text1copy2 textheight">
                                                    <label class="label-text padL27" style="line-height: 24px;">السعر
                                                        بعد الخصم</label>
                                                </div>
                                                <div class="inputHome inputhomecopy inputhomecopy3"
                                                    style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                                            ...
                                            <div class="row">
                                                <div class="text1 text1copy2 textheight">
                                                    <label class="label-text padL27" style="line-height: 24px;">نسبة
                                                        الخصم</label>
                                                </div>
                                                <div class="inputHome inputhomecopy inputhomecopy3"
                                                    style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                ...
                <div class="overflow">
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="row FormWrapper FormWrapper2 FormWrapper13" style="max-width:310px">
                                <div class="row">
                                    <div class="text1 text1copy" style="min-width:140px">
                                        <label class="label-text">سعر قديم</label>
                                    </div>
                                    <div class="input">
                                        <input type="number" min="1" size="3" id="amount" class="input-fld"
                                            on="input-throttled:AMP.setState({getinput9:{per9: event.value}});" required
                                ...
                                <div class="row">
                                    <div class="text1 text1copy" style="min-width:140px">
                                        <label class="label-text">سعر جديد</label>
                                    </div>
                                    <div class="input">
                                        <input type="number" min="1" size="7" id="percentage" class="input-fld"
                                            on="input-throttled:AMP.setState({getinput9:{totl_amt9: event.value}});"
                                        ...
                                        <template type="amp-mustache">
                                            <div class="row">
                                                <div class="text1 text1copy textheight" style="min-width:140px">
                                                    <label class="label-text padL27" style="line-height: 24px;">بدون
                                                        نسبة</label>
                                                </div>
                                                <div class="inputHome inputhomecopy inputhomecopy3"
                                                    style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                                            ...
                                            <div class="row">
                                                <div class="text1 text1copy textheight" style="min-width:140px">
                                                    <label class="label-text padL27"
                                                        style="line-height: 24px;">مدخرات</label>
                                                </div>
                                                <div class="inputHome inputhomecopy inputhomecopy3"
                                                    style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                                                    {{output2}}
