                ...
                <div class="overflow">
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="row">
                                <div class="FormWrapper FormWrapper2 FormWrapper8 FormWrapper11">
                                    <div class="row">
                                        <div class="text1">
                                            <label class="label-text">سعر الفاتورة</label>
                                        </div>
                                        <div class="input">
                                    ...
                                    <div class="row">
                                        <div class="text1">
                                            <label class="label-text">نسبة الاكرامية</label>
                                        </div>
                                        <div class="input">
                                    ...
                                    <div class="row">
                                        <div class="text1">
                                            <label class="label-text">عدد الاشخاص</label>
                                        </div>
                                        <div class="input">
                                            ...
                                            <template type="amp-mustache">
                                                <div class="row">
                                                    <div class="text1 textheight">
                                                        <label class="label-text">مجموع الاكرامية</label>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="text1 textheight">
                                                        <label class="label-text">الاكرامية لكل شخص</label>
                                                    </div>
                                                    <div class="inputHome inputhomecopy inputhomecopy3"
                                                        style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: system-ui;">
                                                        {{output2}}
                                                ...
                                                <div class="row">
                                                    <div class="text1 textheight">
                                                        <label class="label-text">المجموع لكل شخص </label>
                                                    </div>
                                                    <div class="inputHome inputhomecopy inputhomecopy3"
                                                        style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: system-ui;">
                                                        {{output3}}
                                                ...
                                                <div class="row">
                                                    <div class="text1 textheight">
                                                        <label class="label-text">الإجمالي لكل شخص بدون طرف</label>
                                                    </div>
                                                    <div class="inputHome inputhomecopy inputhomecopy3"
                                                        style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: system-ui;">
                                                        {{output4}}
                                                ...
                                                <div class="row">
                                                    <div class="text1 textheight">
                                                        <label class="label-text">المجموع الكلي</label>
                                                    </div>
                                                    <div class="inputHome inputhomecopy inputhomecopy3"
                                                        style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: system-ui;">
                                                        {{output5}}
