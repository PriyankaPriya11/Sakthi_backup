                    ...
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="FormWrapper FormWrapper4">
                                <div class="row">
                                    <div class="text1">
                                        <label class="label-text">ماهي نسبة الزيادة من </label>
                                    </div>
                                    <div class="input">
                                ...
                                <div class="row">
                                    <div class="text1">
                                        <label class="label-text">الى</label>
                                    </div>
                                    <div class="input">
                    ...
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <div class="img-cal">
                            <amp-img alt=" Percent Decrease calculator" src="images/percent-decrease-calculator.png"
                                width="160" height="70" layout="responsive" class="heartBeat"></amp-img>
                        </div>
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="FormWrapper FormWrapper4">
                                <div class="row">
                                    <div class="text1">
                                        <label class="label-text">ماهي نسبة النقصان من</label>
                                    </div>
                                    <div class="input">
                                        <input type="number" min="1" size="3" id="amount" class="input-fld" required
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="text2">
                                            <label class="label-text">٪ تخفيض</label>
                                        </div>
                                    </div>
                                    <div submit-error style="color:red">
                                        <template type="amp-mustache">
            ...
            <div class="overflow">
                        <div class="form block" amp-fx="fly-in-bottom">
                            ...
                            <div class="overflow ss-arab">
                                ...
                                <p class="desc">يمكنك أيضا زيارة حاسبة فرق النسبة المئوية، حاسبة الإكرامية ، حاسبة الراتب ، الخ  </div>
