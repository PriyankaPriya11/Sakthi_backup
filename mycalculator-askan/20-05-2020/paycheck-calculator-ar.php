                    ...
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="FormWrapper">
                                ...
                                <div class="row">
                                    <div class="text1 textheight">
                                        <label class="label-text"> نسبة الزيادة</label>
                                    </div>
                                    <div class="input">
                                ...
                                <div class="row">
                                    <div class="text1 textheight">
                                        <label class="label-text">مجموع الراتب</label>
                                    </div>
                                    <div class="inputHome inputhomecopy inputhomecopy3">
                                        <div submit-success
                            ...
                            <div class="FormWrapper FormWrapper8">
                                <div class="row">
                                    <div class="text1 text1copy2 textheight">
                                        <label class="label-text">الراتب </label>
                                    </div>
                                    <div class="input">
                                        <input type="number" min="1" id="amount" class="input-fld"
                                ...
                                <div class="row">
                                    <div class="text1 text1copy2 textheight">
                                        <label class="label-text">عدد ايام العمل في الاسبوع</label>
                                    </div>
                                    <div class="input">
                                ...
                                <div class="row">
                                    <div submit-success
                                        ...
                                        <template type="amp-mustache">
                                            <div class="row">
                                                <div class="text1 text1copy2 textheight">
                                                    <label class="label-text">الدفع لكل دقيقة</label>
                                                </div>
                                                <div class="inputHome inputhomecopy inputhomecopy3"
                                                    style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                                                    {{output1}}
                                            ...
                                            <div class="row">
                                                <div class="text1 text1copy2 textheight">
                                                    <label class="label-text">الأجر بالساعة</label>
                                                </div>
                                                <div class="inputHome inputhomecopy inputhomecopy3"
                                                    style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: Tahoma;">
                                                    {{output2}}
                    ...
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <div class="overflow Contentpad ss-arab">
                            ...
                            <p class="desc"><b>حاسبة زيادة الراتب</b></p>
                                    ...
                                    <ol class="paycheck"> 
                                        <li>  نحسب عدد ساعات العمل في الأسبوع بضرب ساعات العمل اليومية بعدد أيام العمل في الأسبوع.</li>  
                                        <li> يتم احتساب راتبك السنوي عن طريق ضرب راتبك الشهري ب 12 (شهر في عام)</li>  
                                        <li>  ثم يتم تقسيم راتبك السنوي على 52.14 (عدد الأسابيع التي لدينا في السنة) للحصول على راتبك الأسبوعي </li>  
                                        <li>   يتم تقسيم نتيجة الخطوة 3 على نتيجة الخطوة 1 للحصول على راتبك لكل ساعة. </li>  
                                    </ol>                                    
