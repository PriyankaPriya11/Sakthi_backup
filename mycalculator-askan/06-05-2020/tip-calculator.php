                            ...
                            <div class="row">
                                <div class="FormWrapper FormWrapper2">
                                    <div class="row">
                                        ...
                                        <div class="input">
                                            <input type="number" min="1" size="3" id="amount" class="input-fld" on="input-throttled:AMP.setState({getinput:{totl_amt: event.value}});change:AMP.setState({charState_fsblock_five: event.value <=  0  ? 'Please input numerical values greater than 0' : '' }),msg_fs_five.show" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="text1">
                                        ...
                                        <div class="input">
                                            <input type="number"  min="1" size="7" id="percentage" class="input-fld" on="input-throttled:AMP.setState({getinput:{per: event.value}});change:AMP.setState({charState_fsblock_five: event.value <=  0  ? 'Please input numerical values greater than 0' : ''}),msg_fs_five.show" />
                                        </div>
                                        <div class="text2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input">
                                            <input type="number" min="1" size="7" id="percentage" class="input-fld" on="input-throttled:AMP.setState({getinput:{people: event.value}});change:AMP.setState({charState_fsblock_five: event.value <=  0  ? 'Please input numerical values greater than 0' :  '' }),msg_fs_five.show" />
                                        </div>
