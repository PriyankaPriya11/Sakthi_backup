...
.row {margin-bottom: 11px;overflow: hidden;justify-content: space-between;}
...
@media only screen and (max-width: 360px){
  ...
  <body class="ar tbl ss-twt"> 
    ...
    <form onsubmit = "event.preventDefault(); myfunction();">
        ...
        <div class="row">
            <div class="text1 text3">
                <label class="label-text"> % النسبة المئوية للزيادة في السنة</label>
            </div>
            <div class="input input2">
                ...
                document.getElementById("myyear").setAttribute("style", "box-shadow: none;border: 1px solid #ccc;");
                 ...
                 var text = "";
                  for(var i = 0; i < year; i++){
                        ...
                        text +="<div class='row'><div class='text1'><label class='label-text'>"+ (+i + +1) + " العام</label></div><div class='input input2'><input   type='text' name='y" + i + "' class='input-fld' value='" + incr_answer.toFixed(2) + "' readonly></div></div>";
