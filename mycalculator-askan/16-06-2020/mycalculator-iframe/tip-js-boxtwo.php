...
.FormWrapper{display: block;background-color: whitesmoke;padding: 0px;max-width: 350px;
...
@media only screen and (max-width: 599px) {
    .row { display: block;}
    .FormWrapper .input { max-width: 80%;}
    .text1 { margin-bottom: 5px; max-width: 50%; min-width: 50%;}
...
/* .FormWrapper .text1 { width: 60%;} */
  ...
  <body> 
    <div class="FormWrapper">    
        <div class="row">
            ...
            <div class="input">
                <input type="number"  id="priceBefore" class="input_result input-fld"/>
            </div>
        </div>
        <div class="row">
            <div class="text1">
            ...
            <div class="input">
                <input type="number"  id="DiscountAmount" class="input_result input-fld"/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Price After Discount</label>
            </div>
            <div class="input">
                <input type="number" readonly id="PriceAfter" class="input_result input-fld"/>
            </div>
        </div>
        <div class="row">
            <div class="text1">
                <label class="label-text">Discount Percentage</label>
            </div>
            <div class="input">
                <input type="number" readonly id="DiscountPercent" class="input_result input-fld"/>
            </div>
        </div>
        ...
        <script>
              function myfunction(){
                var PriceBefore = document.getElementById("priceBefore").value;
                var DiscountAmt = document.getElementById("DiscountAmount").value;
                var patt1 = /[A-Za-z-!@#$%^&*()+=]/g;
                var PriceBf=parseFloat(PriceBefore);
                var DiscountPrce=parseFloat(DiscountAmt);
  var PriceBefore1 = PriceBefore.match(patt1);
  var DiscountAmt1 = DiscountAmt.match(patt1);
  if(DiscountAmt1 || PriceBefore1)
  {
  ...
  else if(PriceBefore<=0 || DiscountAmt=="")
  {
  document.getElementById("error_msg").innerHTML = 'Please input numerical values greater than 0';
  document.getElementById("PriceAfter").value=''; 
  document.getElementById("DiscountPercent").value='';
  ...
  else if (PriceBf < DiscountPrce ) 
  {
    document.getElementById("error_msg").innerHTML = 'Please input a value greater than the discount amount';
  document.getElementById("PriceAfter").value='';
  document.getElementById("DiscountPercent").value='';
  return false;
  }
...
var text = "";
var tipamount   = (PriceBefore-DiscountAmt);
var SecondOne=((DiscountAmt) / (PriceBefore))*100 ;
document.getElementById("PriceAfter").value=tipamount.toFixed(2);
document.getElementById("DiscountPercent").value=SecondOne.toFixed(2);
  }
</script>
