...
.amortisationLink.amor_click_nw{
    padding: 9px 15px;
}
@media screen and (max-width:490px){
    div#amortisationLinkDiv{
        margin-top: 9%;
    }
}
...
<body>
    <div class="FormWrapper">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Annual interest rate</label>
            </div>
            <div class="input">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Number of months</label>
            </div>
            <div class="input">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Loan start date</label>
            </div>
            <div class="input">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Extra upfront fees</label>
            </div>
            <div class="input">
        ...
        <div class="calculateDiv2">
            <input type="submit" name="salary_btn" id="salary_btn" value="Calculate" onclick="myfunction()"
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Monthly interest rate</label>
            </div>
            <div class="input">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Total interest</label>
            </div>
            <div class="input">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Monthly payments</label>
            </div>
            <div class="input">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Total to be paid</label>
            </div>
            <div class="input">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Estimated payoff date </label>
            </div>
            <div class="input">
        ...
        <div id="montly_list" style="display:none">
            <div align="center" id="amortisationLinkDiv">
                <a href="#" onclick="showAmortisation(); return false;" class="amortisationLink amor_click_nw">Show repayment
                    schedule</a>
            </div>
            <div>
                <h3 id= "loan_message" style='display:none;'>  Loan payments by month </h3>
    ...
    function myfunction() {
      ...
      var monthly_intestess=  annualIntrests/12;
        ...
        if (loanAmount != '' && annual_intrest != '' && month != '') {
            ...
            document.getElementById("total_paid").value = (parseInt(loanAmount) + parseInt(((result * month) - loanAmount).toFixed(2)) + parseInt(extrafee_amount));
    ...
    function amort(balance, interestRate, terms) {
        ...
        var payment = loanAmount* (monthlyRate / (1 - Math.pow(
            1 + monthlyRate, -terms)));

        //begin building the return string for the display of the amort table
        //add header row for table to return string
        var result = "<table border='1'><tr><th>Payment Date</th><th>Principal</th><th>Interest</th><th>Payment</th><th>Balance</th>" ;
