...
body.ar.tbl.ss-mpc .FormWrapper .row {
    flex-direction: row-reverse;
}
@media screen and (max-width:559px){
    .ar div#mothly_payment_list{
...
<body class="ar tbl ss-mpc">
    <div class="FormWrapper">
        ...
        <div class="row">
           <div class="text1">
                <label class="label-text">التاريخ المتوقع للسداد </label>
            </div>
            <div class="input">
    ...
    function myfunction() {
      ...
      if(extrafee_amount !== ''  && extrafee_amount >0)
        {
            extrafee_amount=extrafee_amount;
        }
        else 
        {
            extrafee_amount=0;
    ...
    function amort(balance, interestRate, terms) {
        ...
        var result = "<table border='1'><tr><th>الرصيد</th><th>إجمالي الدفعة</th><th>الفائدة</th><th>الدفعة الرئيسية</th><th>تاريخ الدفع</th>" ;
