                              ...
                              <form id="myform" method="post"
                                  ...
                                  <div class="row dFlex w2">
                                      <div class="row1">
                                          ...
                                          <div class="inputHome" style="width: 183px; ">
                                      ...
                                      <div class="row2">
                                          <div class="row results">
                                              ...
                                              <div class="inputHome " style="border: 1px solid #ccc;border-radius: 7px;padding: 19px 19px 19px 6px;">
                                  ...
                                  <div class="row2">
                                      <div class="row results">
                                          <div class="calculateDiv">
                                              <button type="button" class="a-bouns calculateBtn" on="tap: AMP.setState({
                     mycalc4:{
                      value1:  getinput4.out4 > 0 ? getinput4.totl_amt4 > 0 ? calc4(getinput4.out4) / (getinput4.totl_amt4) *100: '' : ''
                          ...
                          <div class="FormBlock">
                              ...
                              <div class="row dFlex dFlex1  w5">
                                  <div class="row1 row1_copy">
                                      ...
                                      <div class="inputHome">
                                          <input type="number" min="1" size="7" id="percentage" class="input-fld"
                                              on="input-throttled:AMP.setState({getinput5:{totl_amt5: event.value}});change:AMP.setState({charState_fsblock_four: event.value <=  0  ? 'Please input numerical values greater than 0' : ''}),msg_fs_four.show" />
                                      </div>
                                      <div class="text1Home">
                                          <label class="label-text homelabel-vi">is</label>
                                      </div>
                                      <div class="inputHome">
                                          <input type="number" min="1" size="3" id="amount" class="input-fld"
                                              on="input-throttled:AMP.setState({getinput5:{per5: event.value}});change:AMP.setState({charState_fsblock_four: event.value <= 0 ? 'Please input numerical values greater than 0' :''}),msg_fs_four.show" />
                                      </div>
                                      <div class="text1Home">
                                          <label class="label-text homelabel-vi">?</label>
                                      </div>
                          ...
                          <div class="FormBlock">
                              ...
                              <div class="row dFlex w1">
                                ...
                                on="input-throttled:AMP.setState({getinput6:{per6: event.value}});input-debounced:AMP.setState({charState_fsblock_five: event.value <=  0  ? 'Please input numerical values greater than 0' :   getinput6.totl_amt6 == 0 ? 'Please input numerical values greater than 0' : '' }),msg_fs_five.show"/> -->
                                          <input type="number" size="3" min="1" id="amount" class="input-fld"
                                              on="input-throttled:AMP.setState({getinput6:{per6: event.value}});change:AMP.setState({charState_fsblock_five: event.value <=  0  ? 'Please input numerical values greater than 0' :   getinput6.totl_amt6 == 0 ? 'Please input numerical values greater than 0' : '' }),msg_fs_five.show" />

                                      </div>
                                      <div class="text1Home">
                                          <label class="label-text homelabel-vi">Increased/Decresed by
                                      </div>
                                      <div class="inputHome">
                                          <!--<amp-script layout="container" script="hello-world" class="amp-script-sample">-->
                                          <input type="number" min="1" size="7" id="percentage" class="input-fld"
                                              on="input-throttled:AMP.setState({getinput6:{totl_amt6: event.value}});change:AMP.setState({charState_fsblock_five: event.value == 0 ?  'Please input numerical values greater than 0' : getinput6.per6 <= 0 ? 'Please input numerical values greater than 0' : ''}),msg_fs_five.show" />
                                          <!--</amp-script>-->
                                      </div>
                                      <div class="text1Home">
                                          <label class="label-text homelabel-vi"> % ?</label>
                                      ...
                                      <div class="row results">
                                          <div class="calculateDiv">
                                              <button class="a-bouns calculateBtn calculate1" type="button" id="testing"
                                                  on="tap: AMP.setState({
                         mycalc:{
                          value6: getinput6.per6 > 0 ? getinput6.totl_amt6 == 0 ?  '' : getinput6.per6 * (1+ (getinput6.totl_amt6/100)) : ''
                         } 
                       })">Calculate</button>
                                          </div>
                                          <div class="inputHome">
                                              <input type="number" readonly="" [value]="(mycalc.value6).toFixed(2)"
