...
<section id="main">
  <div class="container ss-pr-ar-btn">
    <div class="Percentage">
      <h1 class="m-bottom">Privacy Policy</h1>
      <p class="desc ss-pr-ar">This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service.</p>
      <!--1s calculation-->
      <button class="addToPhone_btn" on="tap:my-lightbox"> Add to Phone </button>
      <div class="overflow">
        <div class="form block" amp-fx="fly-in-bottom" style="padding:7% 5%;">
          <p class="desc">If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>
          <p class="desc"><b>Information Collection and Use</b></p>
          <p class="desc">We take and respect your privacy seriously. We may collect information via cookie or web log. This is to customize services and enhance customer satisfaction. The data we collect are:</p>
          <p class="desc"><b>Log Data</b></p>
          <p class="desc">We want to inform you that whenever you visit our Service, we collect information that your browser sends to us that is called Log Data. This Log Data may include information such as your computer's Internet Protocol ("IP") address, browser version, pages of our Service that you visit, the time and date of your visit, the time spent on those pages, and other statistics.</p>
          <p class="desc"><b>Cookies and Third Party Advertising</b></p>
          <p class="desc">Cookies are files with a small amount of data that is commonly used an anonymous unique identifier. These are sent to your browser from the website that you visit and are stored on your computer's hard drive.</p>
          ...
          <p class="desc"><b>Changes to This Privacy Policy</b></p>
          <p class="desc">We reserve the right to update this privacy policy with or without notice. Thus, we advise you to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page. These changes are effective immediately, after they are posted on this page. By using this site you agree to its privacy policy and use of cookies.</p>
        </div>
      </div>
    </div>
    <div class="share">
    <!--soical share-->
      <ul>
        ...
        <li>
           <amp-iframe id="copy" sandbox="allow-scripts" width="120" height="50" frameborder="0"
              src="https://solutionsouls.com/pfazol/copy.php">
          </amp-iframe>
        </li>
      </ul>
    </div>
    <div class="comments">
        ...
        <amp-facebook-comments width="486" height="50" layout="responsive"
           data-href="https://solutionsouls.com/pfazol/privacy.php">
