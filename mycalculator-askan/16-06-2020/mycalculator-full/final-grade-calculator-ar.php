                ...
                <div class="overflow">
                    <div class="form block " amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="row">
                                <div class="FormWrapper grad_form_width">
                                    <div class="row">
                                        <div class="text1">
                                            <label class="label-text">العلامة المستحقة</label>
                                        </div>
                                        <div class="input">
                                    ...
                                    <div class="row">
                                        <div class="text1">
                                            <label class="label-text">العلامة الكلية</label>
                                        </div>
                                        <div class="input">
                                    ...
                                    <div class="row">
                                        <div class="calculateDiv2 ar_pd_mb">
                                    ...
                                    <div class="row">
                                        <div class="text1 nn_txt">
                                            <label class="label-text">النتيجة </label>
                                        </div>
                                        <div class="inputHome inputhomecopy pd_mb_in mobile_ar_grd_01">
                                            <div submit-success
                ...
                <div class="overflow">
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <div class="overflow Contentpad ss-arab">
                            ...
                            <p class="desc"><span class="c1">بالإضافة إلى حاسبة الدرجات، بإمكانك استخدام </span><span class="c16 c1"><a class="c15" href="/paycheck-calculator-ar.php">حاسبة الراتب</a></span><span class="c1">&nbsp;الخاصة بنا لمعرفة المكافئ اليومي </span><span class="c1">لراتبك</span><span class="c1">&nbsp;الشهري أو يمكنك تجربة </span><span class="c16 c1"><a class="c15" href="/loan-calculator-ar.php">حاسبة القروض</a></span><span class="c1">&nbsp;التي ستساعدك على اتخاذ قرارات مدعومة بأرقام دقيقة.</span></p>
                        </div>
                    </div>
                </div>
                <div class="share">
