                ...
                <div class="Percentage">
                    ...
                    <div class="overflow">
                        <div class="form block" amp-fx="fly-in-bottom">
                            ...
                            <amp-bind-macro id="calc6" arguments="per6, totl_amt6" expression="per6 + 0">
                            </amp-bind-macro>
                            <form id="myform" method="post"
                                  action-xhr="https://www.askantech.com/amp_test/percent_change_validate1.php" target="_blank">
                            <div class="FormWrapper FormWrapper4 per_change_05_06">
                                <div class="row">
                                    <div class="text1 texts1">
                                        <label class="label-text">Old value (value 1)</label>
                                    </div>
                                    <div class="input input_new_05">
                                        <input type="number" min="1" size="3" id="amount" class="input-fld" required name="percent_change1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="input input_new_05">
                                        <input type="number" min="1" size="7" id="percentage" class="input-fld" required name="percent_change2"
                                ...
                                <div class="row" style="margin-bottom:0px;">
                                    <div class="calculateDiv2">
                                        ...
                                        <input type="submit" value="Calculate" class="calculateBtn calculateBtn2">
                                        <p [text]="charState_fsblock_one" hidden id="msg_fs_one"></p>
                                    </div>
                                </div>
                                <div class="row ss-row" style="margin-bottom:0px;">
                                    <div class="text1">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="inputHome inputhomecopy inputhomecopy2 input_outout_per_chan ss-inc-bar">
                                    ...
                                    <div class="text2 text2copy ss-no-pad-rt">
                ...
                <div class="Percentage">
                    ...
                    <div class="overflow">
                        <div class="form block" amp-fx="fly-in-bottom">
                            ...
                            <form id="myform" method="post"
                                  action-xhr="https://www.askantech.com/amp_test/percent_change_validate2.php" target="_blank">
                            <div class="FormWrapper FormWrapper4 per_change_05_06">
                                <div class="row">
                                    <div class="text1 texts1">
                                        <label class="label-text">Old value (value 1)</label>
                                    ...
                                    <div class="input input_new_05">
                                        <input type="number" min="1" size="3" id="amount" class="input-fld" required name="percent_change3"
                                ...
                                <div class="row">
                                    ...
                                    <div class="input input_new_05">
                                        <input type="number" min="1" size="7" id="percentage" class="input-fld" required name="percent_change4"
                                ...
                                <div class="row">
                                     <div class="inputHome inputhomecopy inputhomecopy2 input_outout_per_chan ss-dec-bar">
                                        <div submit-success style ="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: system-ui;">
                                            <template type="amp-mustache">
                                            {{output}}
                                            </template>
                ...
                <div class="Percentage">
                    <div class="overflow">
                        <div class="form block" amp-fx="fly-in-bottom">
                            ...
                            <div class="overflow">
                                <p class="desc">We make countless comparisons daily, how expensive is that person’s
                                    shirt compared with mine? How well did your favorite soccer team perform this season
                                    compared to the last? By how much did your pay go up in the last year? We make these
                                    comparisons daily and to make it easier we made this <b>online percent change
                                        calculator.​</b></p>
                                <p class="desc">Change they say is the only constant thing and knowing how much of it
                                    occurs per time is quite rewarding. The <b>percent​ change calculator</b> lets you
                                    know what that <b>percent change</b> is letting you make informed decisions.</p>

                                <p class="desc"> <b> Percentage Increase Calculator</b></p>

                                <p class="desc">This <b>percentage increase</b> calculator helps you calculate the
                                    <b>percentage increase</b> from what it previously was, to a new value. So if you
                                    notice a hike in movie ticket prices, an increase in the size of your favorite soda
                                    bottle or even a positive change in your grades, this <b>percentage increase
                                        calculator</b> makes it easy and fast to figure out the percentage of increase.
                                </p>
                                <p class="desc">Just like a proficient <b>rate​ of change calculator</b>, the focus is
                                    on what sort of change you are interested in. The <b>percent​ increase
                                        calculator</b> gives only accurate answers every time it is used thanks to an
                                    efficient algorithm. So you can be sure your results are error-free.</p>
                                <p class="desc"> Just enter the lower value in the first box and the higher value in the
                                    second box and then the calculator does the work.</p>
                                <p class="desc">Here’s our formula: </a></p>
                                <p class="desc"> Percentage Increase = Increase/Change in Value (Value 2 - Value
                                    1)/Original Value (Value 1)*100</p>
                                <p class="desc"> <b> Percentage Decrease Calculator</b></p>
                                <p class="desc">A decrease can be a good thing at times, you could want that new phone,
                                    but you can’t afford it. Luckily for you, there’s this Black Friday sale, you are
                                    able to afford it due to a decrease in price. What’s the value of the decrease in
                                    percentage? A <b>percentage decrease calculator</b> will help in figuring that out.
                                </p>
                                <p class="desc">
                                    Have you been working out for your summer body and you would like to
                                    <b>calculate</b> the decrease in your weight? This calculator makes it easier to
                                    know.
                                </p>
                                <p class="desc"></p>
                                <p class="desc">Enter the higher value in the first textbox and the smaller value into
                                    the second textbox. Click the calculate button and you would have your results.</p>
                                <p class="desc">Here’s how we calculate the <b>percentage decrease:</b></p>
                                <p class="desc"> Percentage Decrease = Decrease/Change in Value (Value 1 - Value
                                    2)/Original Value (Value 1) *100</p>
                                <p class="desc">Use these calculators to figure out the percentage increase/decrease in
                                    whatever you would like to calculate. It is not just helpful for accurate answers,
                                    but it also saves you a lot of time that you could spend on other things, and it
                                    eliminates stress by being efficient, easy to use, effective, and it is absolutely
                                    free to use.</p>
