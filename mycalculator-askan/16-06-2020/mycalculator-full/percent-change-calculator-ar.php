                ...
                <div class="overflow">
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            target="_blank">
                            <div class="FormWrapper FormWrapper4 form_inc arr_mon_0506 ss-panel-wd">
                                <div class="row">
                                ...
                                <div class="row" style="margin-bottom:0">
                                    <div class="text1">
                                        ...
                                        <div class="row">
                                    <div class="inputHome inputhomecopy inputhomecopy2 input_cop_2 per_ar_bx_06 arr_01_06 ss-incar-bar">
                                        <div submit-success
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="FormWrapper FormWrapper4 form_inc arr_mon_0506 ss-panel-wd">
                                ...
                                <div class="row" style="margin-bottom:0">
                                    ...
                                    <div class="row">
                                        <div class="inputHome inputhomecopy inputhomecopy2  input_cop_2 cop_mobile per_ar_bx_06  arr_01_06 ss-decar-bar">
                                            <div submit-success
                                                style="font-size: 15px;display: flex;align-items: center; margin:0px; line-height:1px; font-family: system-ui;">
                                                <template type="amp-mustache">
                                                    {{output}}
