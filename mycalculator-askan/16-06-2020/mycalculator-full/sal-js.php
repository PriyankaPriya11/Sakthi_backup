  ...
  <body> 
    <div class="FormWrapper">    
        <div class="row">
            ...
            <div class="input">
                <input type="text"  id="salarAmount" class="input_result input-fld"/>
            </div>
        </div>
        <div class="row">
            <div class="text1">
            ...
            <div class="input">
                <input type="text" id="salarIncrement" class="input-fld" />
            </div>
        </div>
        <div class="row">
            <div class="text1">
            ...
            <div class="input">
                <input  type="text" name="myyear" id="myyear" class="input-fld" />
            </div>
        </div>
