...
<body>
    <div class="FormWrapper">
        <div class="row">
            ...
            <div class="input">
                <input type="text" id="loanAmount" class="input_result input-fld" />
            </div>
        </div>
        <div class="row">
            <div class="text1">
            ...
            <div class="input">
                <input type="text" id="annualIntrest" class="input-fld" />
            </div>
        </div>
        <div class="row">
            <div class="text1">
            ...
            <div class="input">
                <input type="text" name="nomonth" id="nomonth" class="input-fld" />
            </div>
        </div>
        <div class="row">
            <div class="text1">
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Extra Fees(optional)</label>
            </div>
            <div class="input">
                <input type="text" name="extra_fee" id="extra_fee" class="input-fld" />
            </div>
        </div>
        ...
        <div class="row">
            <div class="text1">
                <label class="label-text">Total Intrest</label>
            </div>
            <div class="input">
        ...
        <div id="montly_list" style="display:none">
            <div align="center" id="amortisationLinkDiv">
                <a href="#" onclick="showAmortisation(); return false;" class="amortisationLink">Show Repayment
                    Schedule</a>
            </div>
            <div>
