...
<div class="container">
    ...
    <div class="col12 pad0 ftr_new_pad0">
                <div class="col2 pad0 pad_new pad_01_06_new">
                    <ul>
                        <li>
                            <a href="privacy.php">Privacy Policy</a>
                            <ul>
...
<div class="date center" style="padding-top:50px;">
    ...
    <amp-user-notification id="my-notification" class="sample-notification" layout="nodisplay">
      <p class="cookieText">By clicking "I accept" or continuing to use our site, you agree to our website's <a id="privacypolicy" href="privacy.php">Privacy Policy</a></p>
        <button on="tap:my-notification.dismiss, privacypolicy.hide">I Accept</button>
