    ...
    document.getElementById("error_msg").innerHTML = ''; 
            ...
            var text = "";
               //   for(var i = 0; i < year; i++){
                        ...
                        text +="<div class='row'><div class='text1'><label class='label-text'>5%</label></div><div class='input'><input type='text' name='y" + i + "' class='input-fld' value='" + incr_answer.toFixed(2) + "' readonly></div></div>";
