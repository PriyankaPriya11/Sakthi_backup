            ...
            <div class="Percentage">
                    ...
                    <div class="form block" amp-fx="fly-in-bottom">
                        ...
                        <form id="myform" method="post"
                            ...
                            <div class="FormWrapper">
                                <div class="row">
                                    <div class="text1">
                                        <label class="label-text">القيمة 1</label>
                                    </div>
                                    <div class="input">
                                ...
                                <div class="row">
                                    <div class="text1">
                                        <label class="label-text">القيمة 2</label>
                                    </div>
                                    <div class="input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="inputHome inputhomecopy pd_mb_in percent_01_6_11">
                                        <div submit-success
                ...
                <div class="form block" amp-fx="fly-in-bottom">
                    ...
                    <div class="overflow Contentpad ss-arab">
                        ...
                        <p class="desc"><span>بالنسبة الى نسبة التغيير، فإن الترتيب مهم. ويُستخدم لحساب الفرق بين الرقم القديم والرقم الجديد. إذا كنت ترغب في زيارة حاسبة نسبة التغيير الخاصة بنا، </span><span class="c16 c4"><a class="c15" href="/percent-change-calculator-ar.php">فانقر هنا</a></span><span class="c0">&nbsp;</span></p>
                        ...
                        <ul class="uldiffpage">
                            ...
                            <li>يتم العثور على متوسط القيمتين ((القيمة 1 + القيمة 2)/2)
                                        </li>
