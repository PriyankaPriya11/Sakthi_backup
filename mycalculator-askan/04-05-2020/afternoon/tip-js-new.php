...
p#result .label-text { font-size: 14px; display: flex; align-items: center;}
p#result .text1 { width: 100%;}
p#result .text1 label.label-text { width: 33%;}
@media only screen and (max-width: 320px) {
  p#result .label-text { font-size: 10px;}
}
