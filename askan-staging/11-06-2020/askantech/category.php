        ...
        <div class="div100">
            <div class="wrapper">
                <div class="breadcrumb">
                    <a href="<?php echo site_url(); ?>">Home</a> >> <a class="current" href="<?php echo site_url(); ?>/blog/"/>Category</a>
                </div>
            </div>
        </div>
        <!--breadcrumb-->
            ...
            <div class="wrapper">
                <div class="100">
                    ...
                    <div class="div70 success-stories-inner">
                        <div class="inner-main-title"><?php printf( __( 'Category: %s', 'Askantech' ), single_cat_title( '', false ) ); ?></div>
