                                        ...
                                        <div class="home_slider_item_link">
                                            <div class="author_image">
                                                <div>
                                                    ...
                                                    <img
                                                        src="https://www.askantech.com/wp-content/themes/askantech/images/at-ig.png">
                                                    <?php else: ?>
            ...
            <div class="row row-lg-eq-height">
                ...
                <div class="div100 post-navi">
                    <div class="div50 prev-navi">
                        <a href="">
                            <span><?php previous_post_link('%link', __( '&larr; Previous Post', 'ft' ) ); ?></span>
                        </a>
                    </div>
                    <div class="div50 next-navi">
                        <a href="">
                            <span><?php next_post_link('%link', __( 'Next Post &rarr;', 'ft' ) ); ?></span>
                        </a>
                    </div>
                </div>
