...
<div class="ss-post-bg">
    ...
    <?php $image = get_field('post_feature_ig'); if( !empty( $image ) ): ?>
    <amp-img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" width="1920"
        height="1080" layout="responsive" />
    </amp-img>
    <?php endif; ?>
</div>
<?php $output = ob_get_clean();
...
function ppi_case_study(){ 
    ob_start();     
    ?>
<section id="case-study" class="ss-cs">
    <div id="home" class="header-hero bg_cover d-lg-flex align-items-center ss-home-carousel">
        <div class="ss-amp-container">
            <div class="cc-amp-row">
                <div class="ss-flght">
                    <amp-img src="/wp-content/themes/askantech/assets/cs-assets/images/flight.png" alt="ss-ig"
                        width="980" height="470" layout="responsive"></amp-img>
                </div>
                ...
                <div class="col-lg-6 ss-c6">
                    <div class="header-hero-content">
                        <a href="https://www.askantech.com/laravel-parcel-delivery-system-case-study/">
                            <h1 class="hero-title">
                                <?php the_field('title_blue_1'); ?> <span><?php the_field('title_orange_1'); ?>
                                </span><?php the_field('title_blue_2'); ?>
                                <span><?php the_field('title_orange_2'); ?> </span><?php the_field('title_blue_3'); ?>
                            </h1>
                        </a>
                    ...
                    <button class="button slide"
                        onclick="window.location.href='https://www.askantech.com/laravel-parcel-delivery-system-case-study/';"><?php the_field('discover_btn'); ?></button>
                </div>
            </div>
        </div>
    </div>
</section>
<div class="ss-amp-carousel">
    <!-- <amp-img src="/wp-content/themes/askantech/assets/cs-assets/images/tabimg.png" alt="ss-ig" class="ss-lap-ig" width="780" height="623" layout="responsive"></amp-img>     -->
    <amp-carousel width="400" height="300" layout="responsive" type="slides" class="ss-slide-1">
        <amp-img src="https://www.askantech.com/wp-content/uploads/2019/10/keyfeatures.jpg" width="400" height="300"
            layout="responsive" alt="a sample image"></amp-img>
        <amp-img src="https://www.askantech.com/wp-content/uploads/2019/10/functionaily.jpg" width="400" height="300"
            layout="responsive" alt="another sample image"></amp-img>
        <amp-img src="https://www.askantech.com/wp-content/uploads/2019/10/achived-result.jpg" width="400" height="300"
            layout="responsive" alt="and another sample image"></amp-img>
        <amp-img src="https://www.askantech.com/wp-content/uploads/2019/10/business-gain.jpg" width="400" height="300"
            layout="responsive" alt="and another sample image"></amp-img>
    </amp-carousel>
</div>
<?php $output = ob_get_clean();
...
add_shortcode('ppicasestudy', 'ppi_case_study');

function mg_case_study(){ 
    ob_start();     
    ?>
<section id="case-study" class="ss-cs">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 ss-mgg">
                    <div class="header-hero-content">
                        <a href="https://www.askantech.com/multigadget-case-study/">
                            <h1 class="hero-title ss-mg-h1">
                                <?php the_field('title_pink_1'); ?> <span><?php the_field('title_bluesd_1'); ?></span>
                                <?php the_field('title_pink_2'); ?></h1>
                        </a>
                    ...
                    <div class="ss-details">
                        <div class="ss-country ss-mg-ct">
                            ...
                            <p><?php the_field('country_name_1'); ?> <span><?php the_field('country_state_1'); ?></span>
                            </p>
                        </div>
                    ...
                    <button class="button slide ss-mg-slide"
                        onclick="window.location.href='https://www.askantech.com/multigadget-case-study/';"><?php the_field('discover_btn_1'); ?></button>
                </div>
            </div>
        </div>
    </div>
</section>
<div class="ss-amp-carousel ss-mg-btm">
    <!-- <amp-img src="/wp-content/themes/askantech/assets/cs-assets/images/tabimg.png" alt="ss-ig" class="ss-lap-ig" width="780" height="623" layout="responsive"></amp-img>     -->
    <amp-carousel width="400" height="300" layout="responsive" type="slides">
        <amp-img src="https://www.askantech.com/wp-content/themes/askantech/assets/cs-assets/images/mob-ss-1.png" width="400" height="300"
            layout="responsive" alt="a sample image"></amp-img>
        <amp-img src="https://www.askantech.com/wp-content/themes/askantech/assets/cs-assets/images/mob-ss-2.png" width="400" height="300"
            layout="responsive" alt="another sample image"></amp-img>
        <amp-img src="https://www.askantech.com/wp-content/themes/askantech/assets/cs-assets/images/mob-ss-3.png" width="400" height="300"
            layout="responsive" alt="and another sample image"></amp-img>
        <amp-img src="https://www.askantech.com/wp-content/themes/askantech/assets/cs-assets/images/mob-ss-4.png" width="400" height="300"
            layout="responsive" alt="and another sample image"></amp-img>
    </amp-carousel>
</div>
<?php $output = ob_get_clean();
...
add_shortcode('mgcasestudy', 'mg_case_study');
...
/*AMP SHORTCODES */
    ...
    function askantech_adding_service_style(){
        ...
        if(is_page(2584)){
            ...
            wp_register_style("simple-lightbox",get_template_directory_uri().'/assets/cs-assets/css/simple-lightbox.css');
            wp_enqueue_style("simple-lightbox");
    ...
    function askantech_adding_scripts(){
        ...
        if(is_page(2584)){
            ...
            wp_register_script('simple-lightbox',get_template_directory_uri().'/assets/cs-assets/js/simple-lightbox.js','','',true);
