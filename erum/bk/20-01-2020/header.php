...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="http://localhost/erumproject/wp-content/themes/erum/assets/ele/hk8sx.css" media="all">
  <link rel="stylesheet" type="text/css" href="http://localhost/erumproject/wp-content/themes/erum/assets/css/home.css" media="all">
  <link rel="stylesheet" type="text/css" href="http://localhost/erumproject/wp-content/themes/erum/assets/css/shop.css" media="all">
  <link rel="stylesheet" type="text/css" href="http://localhost/erumproject/wp-content/themes/erum/assets/css/origen.css" media="all">
  <link rel="stylesheet" type="text/css" href="http://localhost/erumproject/wp-content/themes/erum/style.css" media="all">
  <link rel="stylesheet" href="http://localhost/erumproject/wp-content/themes/erum/assets/contact-css/style.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel='stylesheet' href='http://localhost/erumproject/wp-content/themes/erum/assets/css/owl-carousel/owl.carousel.min.css' type='text/css' media='all' />
  <link rel='stylesheet' href='http://localhost/erumproject/wp-content/themes/erum/assets/css/owl-carousel/owl.theme.default.css' type='text/css' media='all' />
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  <link rel="stylesheet" href="http://localhost/erumproject/wp-content/themes/erum/assets/map/css/jquery.bxslider.css">
  <link rel="stylesheet" href="http://localhost/erumproject/wp-content/themes/erum/assets/map/css/map.css">
  <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
  <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js" type="text/javascript"></script> -->
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
  <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script> -->
  <script type='text/javascript' src='http://localhost/erumproject/wp-content/themes/erum/assets/css/owl-carousel/owl.carousel.js'></script>
  <script src="http://localhost/erumproject/wp-content/themes/erum/assets/js/custom.js" type="text/javascript"></script> 
  <script src="http://localhost/erumproject/wp-content/themes/erum/assets/js/shop.js" type="text/javascript"></script>  
  <!-- <script src="http://localhost/erumproject/wp-content/themes/erum/assets/ele/okzp.js" type="text/javascript"></script>   -->
    ...
    <header id="masthead" class="site-header ss-head">
      <div class="site-branding">
        ...
        <div class="light-logo">
          <a href="#" rel="home">
            <img src="http://localhost/erumproject/wp-content/themes/erum/assets/images/logo-wt.png">
          </a>
          <a href="#" rel="home">
            <img src="http://localhost/erumproject/wp-content/themes/erum/assets/images/logo-bk.png">
          </a>
        </div>
      </div><!-- .site-branding -->
              ...
              <section id="text-2" class="widget widget_text">
                <div class="textwidget">
                  <h5><img class="alignnone wp-image-67 size-full"
                      src="http://localhost/erumproject/wp-content/themes/erum/assets/ele/eeeee.png" alt="" width="71"
                      height="91"></h5>
                  <p>&nbsp;</p>
                  <div class="ss-menu-content">
						...
						<div class="ss-menu-social">
							<a href="#"><img src="http://localhost/erumproject/wp-content/themes/erum/assets/images/fb.png"></a>
							<a href="#"><img src="http://localhost/erumproject/wp-content/themes/erum/assets/images/linkedin.png"></a>
							<a href="#"><img src="http://localhost/erumproject/wp-content/themes/erum/assets/images/instagram.png"></a>
						</div>
                </div>
              </section>
            </div><!-- #primary-sidebar -->
