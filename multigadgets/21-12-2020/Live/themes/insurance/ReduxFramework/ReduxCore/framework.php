...
echo '<link rel="stylesheet" id="options-google-fonts"  href="'.$typography->makeGoogleWebfontLink( $this->typography ).'&display=swap&amp;v='.$version.'" type="text/css" media=\'none\' onload="if(media!=\'all\')media=\'all\'" />';
